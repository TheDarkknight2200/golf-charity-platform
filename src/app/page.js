  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <section className="border-y border-gray-800 py-12">
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            <div key={stat.label} className={`scroll-animate opacity-0 delay-${(index + 1) * 100}`}>
      ...
      <section id="how-it-works" className="max-w-5xl mx-auto px-6 py-20">
        <h2 className="scroll-animate opacity-0 text-3xl font-bold text-center mb-4">How It Works</h2>
        <p className="scroll-animate opacity-0 text-gray-400 text-center mb-12">Three simple steps to play, win and give back.</p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={item.step} className={`scroll-animate opacity-0 delay-${(index + 1) * 100} card-hover bg-gray-900 border border-gray-800 rounded-2xl p-8`}>
      ...
      <section className="bg-gray-900/50 border-y border-gray-800 py-20">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="scroll-animate opacity-0 text-3xl font-bold text-center mb-4">Prize Structure</h2>
          <p className="scroll-animate opacity-0 text-gray-400 text-center mb-12">The more you match, the more you win.</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={prize.match} className={`scroll-animate opacity-0 delay-${(index + 1) * 100} card-hover border rounded-2xl p-8 text-center ${prize.color}`}>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        <h2 className="scroll-animate opacity-0 text-3xl font-bold text-center mb-4">Charities We Support</h2>
        <p className="scroll-animate opacity-0 text-gray-400 text-center mb-12">Every subscription contributes to a cause that matters.</p>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {[
            ...
            <div key={name} className={`scroll-animate opacity-0 delay-${(index + 1) * 100} card-hover bg-gray-900 border border-gray-800 rounded-xl px-5 py-4 text-center`}>
      ...
      <section className="max-w-3xl mx-auto px-6 py-20 text-center">
        <h2 className="scroll-animate opacity-0 text-4xl font-bold mb-4">Ready to Play?</h2>
        <p className="scroll-animate opacity-0 text-gray-400 mb-8 text-lg">Join thousands of golfers making a difference with every round.</p>
        <Link href="/auth" className="scroll-animate opacity-0 btn-press bg-green-600 hover:bg-green-500 text-white font-semibold px-10 py-4 rounded-xl transition text-lg inline-block">
